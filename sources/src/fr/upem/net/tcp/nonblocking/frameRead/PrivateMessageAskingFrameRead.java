...
/**
 * Represents a client private message asking frame read
 * Could be visited by a FrameReadVisitor
 */
public class PrivateMessageAskingFrameRead implements FrameRead{
	
	private final String sender;
	private final String receiver;
	
	public PrivateMessageAskingFrameRead(String sender, String receiver) {
